...
//.def	RoundCounter = r21  // counter between two sensor's firing 
//.def	StartDelay = r25	// Delay between sensor fire and start showing (calc from previous RoundCounter)

.def	DelayCount	= r19	//  Show speed regulator

.equ	TapeLen		= 16	// length of led tape

.equ	led			= PB2	// led out pin
.equ	sens		= PB1   // AIN1 sensor in port
.equ	led_port	= PORTB // data port
.equ	led_ddr		= DDRB  // direct databort

.equ	DelayConst	= 50  //200
.equ	StateChange = 1
.equ	StateWait	= 2
...
// Port init:
	...
	outi	led_port, 0			// disable pullups 
// ADC init (ADC1)
; Init ADC
...
; Init Comparator
	outi  ACSR, (1<<ACBG)|(0<<ACIE)
	outi  ADMUX, (0<<REFS2)|(1<<REFS1)|(0<<REFS0)|(0<<ADLAR)|(1<<MUX0)|(0<<MUX1)|(0<<MUX2)|(0<<MUX3) ; Reference = 1.1V,Left Adjust, Channel: PB2 (ADC1)
...
MainLoop:						
//	inc		RoundCounter
	sbis	ACSR, ACO			// Check comparator
	rjmp    ml_no_magnet

; Sensor has fired
//	mov		StartDelay, RoundCounter // Calc next cycle start delay
//	lsr		StartDelay				 // Divide by 2 - set start to another side from sensor
//	ldi		RoundCounter, 0			 // Reset Round time counter
	ldi		ShowingState, 1			 // Enable showing cycle
	rcall	InitNextEffect			// read program line and set effect array pointers (BegArr, EndArr)
...
ShowTape:
	rcall	ReadNextState
	brts	sh_stop_effect		// end of effect	
...
.DB 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
.DB 0x0b,0xbb,0xbb,0xb0,0xff,0xff,0xff,0xf0
.DB 0xb0,0x00,0x00,0x00,0x00,0x0f,0x00,0x00
.DB 0x0b,0xbb,0x00,0x00,0x00,0x0f,0x00,0x00
.DB 0xb0,0x00,0x00,0x00,0x00,0x0f,0x00,0x00
.DB 0x0b,0xbb,0xbb,0xb0,0xff,0xff,0xff,0xf0
.DB 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
.DB 0x0b,0xbb,0x00,0x00,0xff,0xff,0xff,0xf0
.DB 0xb0,0x00,0xb0,0x00,0xf0,0x0f,0x00,0xf0
.DB 0xb0,0x00,0xb0,0x00,0xf0,0x0f,0x00,0xf0
.DB 0x0b,0xbb,0x00,0x00,0xf0,0x0f,0x00,0xf0
.DB 0x00,0x00,0x00,0x00,0xf0,0x00,0x00,0xf0
.DB 0xbb,0xbb,0xb0,0x00,0x00,0x00,0x00,0x00
.DB 0x00,0x00,0xb0,0x00,0xff,0xff,0xff,0xf0
.DB 0x00,0x00,0xb0,0x00,0xf0,0x00,0x00,0x00
.DB 0x00,0x00,0xb0,0x00,0xf0,0x00,0x00,0x00
.DB 0x00,0x00,0x00,0x00,0xf0,0x00,0x00,0x00
.DB 0xbb,0xbb,0xbb,0xb0,0xf0,0x00,0x00,0x00
.DB 0xb0,0x00,0x00,0x00,0x00,0x00,0x00,0x00
.DB 0xb0,0x00,0x00,0x00,0xff,0xff,0xff,0xf0
.DB 0xb0,0x00,0x00,0x00,0xf0,0x00,0x00,0x00
.DB 0x00,0x00,0x00,0x00,0xf0,0x00,0x00,0x00
.DB 0x0b,0xbb,0x00,0x00,0xf0,0x00,0x00,0x00
.DB 0xb0,0x00,0xb0,0x00,0xf0,0x00,0x00,0x00
.DB 0xb0,0x00,0xb0,0x00,0x00,0x00,0x00,0x00
.DB 0xbb,0xbb,0xbb,0xb0,0x0f,0xff,0xff,0x00
.DB 0x00,0x00,0x00,0x00,0xf0,0x00,0x00,0xf0
.DB 0x00,0x00,0x00,0x00,0xf0,0x00,0x00,0xf0
.DB 0x00,0x00,0x00,0x00,0xf0,0x00,0x00,0xf0
.DB 0xb0,0xbb,0xbb,0xb0,0x0f,0xff,0xff,0x00
.DB 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
...
.DB 85,85,85,	0	// e white
.DB 255,255,255,0	// f ultra white
